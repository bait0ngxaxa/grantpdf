...
export default function CreateWordDocPage() {
  ...
  const [signatureCanvasData, setSignatureCanvasData] = useState<string | null>(
    null
  );
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    วันที่สร้างหนังสือ <span className="text-red-500">*</span>
                  </label>
                  <Input
                    type="text"
                    name="date"
                  ...
                  {formData.attachments.map((attachment, index) => (
                    <div key={index} className="flex gap-2 mb-3">
                      <Input
                        ...
                        value={attachment}
                        onChange={(e) =>
                          updateAttachment(index, e.target.value)
                        }
                      />
                      <Button
                        type="button"
                        ...
                        {attachmentFiles.length > 0 && (
                          <div className="mt-4">
                            <h5 className="text-sm font-medium text-slate-700 mb-2">
                              ไฟล์ที่เลือก ({attachmentFiles.length} ไฟล์):
                            </h5>
            ...
            <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    ชื่อผู้ขออนุมัติ <span className="text-red-500">*</span>
                  </label>
                  <Input
                    type="text"
                    name="name"
