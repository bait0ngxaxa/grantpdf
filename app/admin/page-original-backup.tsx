    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.users && data.users.length > 0) {
          // ผู้ใช้ล่าสุดคือคนแรกใน array (เพราะ API sort ตาม created_at desc)
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="card bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6 transform hover:scale-105 transition-transform duration-300">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">สถิติสถานะโครงการ</div>
                        <div className="text-lg font-bold text-purple-600">รายละเอียดสถานะ</div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-gray-600 dark:text-gray-300">กำลังดำเนินการ</span>
                        </div>
                        <span className="font-bold text-yellow-600">{projectStatusStats.pending}</span>
                      </div>
                      
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <div className="w-3 h-3 bg-green-500 rounded-full"></div>
                          <span className="text-sm text-gray-600 dark:text-gray-300">อนุมัติ</span>
                        </div>
                        <span className="font-bold text-green-600">{projectStatusStats.approved}</span>
                      </div>
                      
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <div className="w-3 h-3 bg-red-500 rounded-full"></div>
                          <span className="text-sm text-gray-600 dark:text-gray-300">ไม่อนุมัติ</span>
                        </div>
                        <span className="font-bold text-red-600">{projectStatusStats.rejected}</span>
                      </div>
                      
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <div className="w-3 h-3 bg-orange-500 rounded-full"></div>
                          <span className="text-sm text-gray-600 dark:text-gray-300">แก้ไข</span>
                        </div>
                        <span className="font-bold text-orange-600">{projectStatusStats.editing}</span>
                      </div>
                      
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          <div className="w-3 h-3 bg-gray-500 rounded-full"></div>
                          <span className="text-sm text-gray-600 dark:text-gray-300">ปิดโครงการ</span>
                        </div>
                        <span className="font-bold text-gray-600">{projectStatusStats.closed}</span>
                      </div>
                    </div>
                  </div>
