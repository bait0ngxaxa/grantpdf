...
export default function FileItem({ file, onPreviewPdf, onDeleteFile }: FileItemProps) {
        ...
        <React.Fragment>
            <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
                    ...
                    <div className="flex-shrink-0">
                        {file.fileExtension === 'pdf' ? (
                            ...
                            <svg className="w-8 h-8 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 2a1 1 0 000 2h6a1 1 0 100-2H9zM4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5z" />
                ...
                <div className="flex items-center space-x-2 flex-shrink-0">
                    ...
                    {file.fileExtension === 'pdf' && (
                        <Button
                            onClick={() => onPreviewPdf(file.storagePath!, file.originalFileName)}
