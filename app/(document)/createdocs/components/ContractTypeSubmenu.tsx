            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
                ...
                >
                    <div className="flex flex-col items-center text-center h-full">
                        ...
                        <h3 className="text-xl font-bold text-blue-600 mb-2 text-balance">
                            ABS
                        </h3>
                ...
                <div
                    className="group bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-xl hover:border-green-200 dark:hover:border-green-800 duration-300 cursor-pointer hover:-translate-y-1 transition"
                ...
                >
                    <div className="flex flex-col items-center text-center h-full">
                        ...
                        <h3 className="text-xl font-bold text-green-600 mb-2 text-balance">
                            DMR
                        </h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                            สัญญาจ้างประเภท DMR
                ...
                <div
                    className="group bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-xl hover:border-purple-200 dark:hover:border-purple-800 duration-300 cursor-pointer hover:-translate-y-1 transition"
                ...
                >
                    <div className="flex flex-col items-center text-center h-full">
                        ...
                        <h3 className="text-xl font-bold text-purple-600 mb-2 text-balance">
                            SIP
                        </h3>
                        <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">
                            สัญญาจ้างประเภท SIP
