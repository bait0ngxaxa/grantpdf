...
export const ProjectCard = ({
    ...
    return (
        <div
            className={cn(
                "cursor-pointer transition-[color,background-color,border-color,opacity,box-shadow,transform,filter] duration-300 border rounded-3xl p-6",
                isSelected
        ...
        >
            <div className="flex items-center gap-5">
                <div
                    className={cn(
                        "flex items-center justify-center p-4 rounded-2xl flex-shrink-0 transition-colors",
                        isSelected
