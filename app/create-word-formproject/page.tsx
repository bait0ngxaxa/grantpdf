  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(
          `เกิดข้อผิดพลาด: ${errorText || "ไม่สามารถสร้างเอกสาร Word ได้"}`
        );
        setIsError(true);
      }
    } catch (error) {
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-slate-50 p-6 rounded-lg border border-slate-200">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    ระยะเวลาดำเนินการ <span className="text-red-500">*</span>
                  </label>
                  <Input
                    type="text"
                    name="timeline"
            ...
            <div className="bg-green-50 p-6 rounded-lg border border-green-200">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    เป้าประสงค์ <span className="text-red-500">*</span>
                  </label>
                  <Textarea
                    name="goal"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    เป้าหมายโครงการ <span className="text-red-500">*</span>
                  </label>
                  <Textarea
                    name="target"
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    กรอบการดำเนินงาน <span className="text-red-500">*</span>
                  </label>
                  <Textarea
                    name="scope"
      ...
      <Dialog open={isPreviewOpen} onOpenChange={setIsPreviewOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div>
              <h4 className="font-semibold text-sm text-gray-600">ผลผลิต:</h4>
              <p className="text-sm">{formData.product || "-"}</p>
            </div>
            <div>
              <h4 className="font-semibold text-sm text-gray-600">ผลลัพธ์:</h4>
