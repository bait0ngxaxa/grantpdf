                    ...
                    <div className="flex justify-between items-center py-6">
                        <div>
                            ...
                            <p className="text-gray-600">
                                อัพโหลดไฟล์เอกสาร ไฟล์แนบเพิ่มเติม
                            </p>
                        </div>
                        <Button
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                {isLoadingProjects ? (
                                    ...
                                    <div className="space-y-3 max-h-[50vh] overflow-y-auto p-2 bg-gray-50 rounded-lg">
                                        {projects.map((project) => (
                                            <div
                                                key={project.id}
                                                className={`card bg-white shadow-sm cursor-pointer transition-all duration-200 border-2 ${
                                                    selectedProjectId ===
                                                    project.id
                                            ...
                                            >
                                                <div className="card-body p-4">
                                                    <div className="flex items-center space-x-3">
                                                        <div className="flex items-center justify-center p-2 rounded-full bg-primary/10 flex-shrink-0">
                                                            <svg
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            {project.description && (
                                                                <p className="text-xs text-base-content/60 mb-2 line-clamp-2 overflow-hidden text-ellipsis break-words">
                                                                    {
                                                                        project.description
                                                                    }
                                                                </p>
                            ...
                            {/* Instructions moved to left column */}
                            <div className=" w-full bg-blue-50 rounded-lg p-4 lg:p-6">
                                ...
                                <ul className="text-sm text-blue-700 space-y-2">
                                    ...
                                    <li>
                                        • สามารถลากไฟล์มาวางในพื้นที่อัพโหลด
                                    </li>
                                    <li>
                                        •
                                        ไฟล์ที่อัพโหลดจะถูกเชื่อมโยงกับโครงการที่เลือก
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                >
                                    {selectedFile ? (
                                        <div className="space-y-4">
                                            <div className="w-12 h-12 lg:w-16 lg:h-16 mx-auto bg-green-100 rounded-full flex items-center justify-center">
                                                <svg
                                            ...
                                            <div>
                                                <h4 className="text-base lg:text-lg font-medium text-gray-900">
                                                    ไฟล์ที่เลือก
                                                </h4>
                                        ...
                                        <div className="space-y-4">
                                            <div className="w-12 h-12 lg:w-16 lg:h-16 mx-auto bg-primary rounded-full flex items-center justify-center">
                                                <svg
