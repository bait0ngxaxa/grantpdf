                    ...
                    <div className="grid gap-5 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.15fr)] lg:items-start">
                        <section className="rounded-2xl border border-white/70 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                            <div className="mb-6 flex flex-col items-center text-center">
                                <div className="mb-4 flex h-24 w-24 items-center justify-center rounded-full bg-white shadow-xl ring-4 ring-white/60">
                                    <div className="flex h-20 w-20 items-center justify-center rounded-full bg-slate-100 text-3xl font-bold text-blue-600 dark:bg-slate-700 dark:text-blue-400">
                                        {session?.user?.name
                                            ?.charAt(0)
                                            .toUpperCase() ||
                                            session?.user?.email
                                ...
                                <DialogTitle className="mb-1 text-2xl font-bold text-slate-800 dark:text-slate-100">
                                    ข้อมูลส่วนตัว
                                </DialogTitle>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-4 rounded-2xl border border-slate-100 bg-slate-50 p-4 dark:border-slate-600 dark:bg-slate-700/50">
